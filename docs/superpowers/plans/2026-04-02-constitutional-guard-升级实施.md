...
- [ ] **Step 1: 复制现有 skill 到 canonical 新目录**
...
- [ ] **Step 2: 写新的 canonical `SKILL.md` failing checklist**
...
- [ ] **Step 4: 写 `project-law-overlay.md`**
...
- [ ] **Step 6: 手工检查 canonical 与 alias 语义不打架**
...
- [ ] **Step 1: 写 `pre-code-calibration.md`**
...
- [ ] **Step 2: 写 `in-flight-drift-correction.md`**
...
- [ ] **Step 4.1: 更新 `conformance-examples.md`**
...
- [ ] **Step 5: 升级 `check_protocol_conformance.py`**
...
- [ ] **Step 6: 升级 `run_fixture_batch.py`**

要求：
- 按新 tags 跑三态矩阵
- 能快速筛选 `pre` / `in-flight` / `post` / `combo`

- [ ] **Step 7: 写死 holdout 约束**
