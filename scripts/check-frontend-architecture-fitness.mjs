...
const 热点文件行数上限 = [
  // 用户裁决：所有热点文件预算统一对齐全局上限 1597 有效行，
  // 不再为单文件维护精钉预算；全局完成态硬上限 1597 已经兜底防膨胀。
  { path: "frontend/应用根/聊天状态.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/房间消息窗/壳.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/房间消息窗/附件渲染.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/房间消息窗/视频附件渲染.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/房间消息窗/图片附件渲染.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/房间消息窗/消息虚拟列表.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/房间消息窗/视图.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/房间消息窗/文本布局.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/媒体/运行时.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/时间线/滚动器.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/应用根/聊天应用内核.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/应用根/聊天壳.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/应用根/聊天壳样式.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/应用根/聊天内核状态投影.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/应用根/聊天内核平台运行时.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/应用根/聊天内核通知副作用.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/媒体/播放会话/应用.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/媒体/播放会话/会话投影.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/媒体/播放会话/草稿发布.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/媒体/播放会话/运行时副作用.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/媒体/播放会话/自动播候选预热.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/媒体/播放会话/查看器播放释放.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
  { path: "frontend/恢复/应用.ts", maxEffectiveLines: 1597, maxPhysicalLines: 1800 },
