...
pub fn build_app(pool: PgPool) -> Router {
    Router::new()
        ...
        .route("/rooms/{room_id}/roles/promote", post(http::promote_room_admin))
        .route("/rooms/{room_id}/roles/demote", post(http::demote_room_admin))
        ...
        .route("/rooms/{room_id}/members/{member_id}/mute", post(http::mute_room_member))
        .route("/rooms/{room_id}/members/{member_id}/remove", post(http::remove_room_member))
