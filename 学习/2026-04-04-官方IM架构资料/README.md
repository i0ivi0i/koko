...
- `whatsapp-meta/labyrinth-encrypted-message-storage-protocol-2023.md`
...
- `whatsapp-meta/whatsapp-dit-de-identified-data-collection.md`
  原始地址：`https://engineering.fb.com/2021/04/16/security/dit/`
  价值：补充理解 WhatsApp / Meta 如何在隐私与系统演进之间做边界设计。

## 推荐阅读顺序

1. `socket.io/delivery-guarantees.md`
2. `socket.io/connection-state-recovery.md`
3. `telegram/working-with-updates.md`
4. `whatsapp-meta/whatsapp-multi-device.md`
5. `whatsapp-meta/meta-security-principles-private-messaging-2022.md`
