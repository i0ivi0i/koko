...
- 架构判断
  ...
  - [短视频信息流丝滑播放与媒体预算模型-2026-04-27.md](./短视频信息流丝滑播放与媒体预算模型-2026-04-27.md)
    把 X / TikTok / Dashlet / XGPlayer 的公开模型收成 `koko` 可施工的媒体预算规则：当前项重播放、邻近项轻预热、远处项冷表达。
...
- 轮子与基础设施选择
  ...
  - [客户端派生预览与零长期轻封面-官方实践清单-2026-04-21.md](./客户端派生预览与零长期轻封面-官方实践清单-2026-04-21.md)
    专门为“同文件 preview hint + 客户端派生 preview cache + 零长期 still”整理的官方边界、API 速查和反手搓裁决。
  - [高清视频自动播放与激进协作分发实现前官方API清单-2026-04-21.md](./高清视频自动播放与激进协作分发实现前官方API清单-2026-04-21.md)
    只收这轮自动播放/激进补齐施工会直接用到的官方 API、浏览器边界和当前代码触点，避免 plan 靠印象乱写。
