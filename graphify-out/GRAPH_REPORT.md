...
Cohesion: 0.03
Nodes (54): abandon_media_upload(), AbandonMediaUploadBody, ApiError, axum_ws_message_to_tungstenite(), Blob媒体资产响应参数, BootstrapBody, Canonical图片校验结果, 媒体complete测试环境 (+46 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (3): 未来冷源到期时间戳秒(), 插入ready图片附件记录(), 会话所属匿名身份返回内部uuid而不是兼容旧串()
...
Cohesion: 0.09
Nodes (14): 创建资产协作分发Actor(), AdminLoginBody, AdminLoginResp, 尝试加载dotenv(), flush(), 签发协作分发join_ticket(), make_writer(), 附件owner不匹配时拒绝创建消息() (+6 more)
...
- **Thin community `Community 22`** (2 nodes): `图片资产描述只暴露canonical而不是服务端派生多版本()`, `blob媒体资产契约测试.rs`
...
- **Why does `单连接发送到已关闭socket时降级为正常断开()` connect `Community 4` to `Community 0`, `Community 10`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `提取媒体上传授权头()` connect `Community 0` to `Community 1`, `Community 2`, `Community 6`, `Community 17`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
